...
```bash
python sweep_thresholds.py --taus 0.01 0.03 0.1 0.3 1 --duration 2 --min-voltage 1000 --max-voltage 20000 --scan-points 12 --output results/tau_asymptote --workers 12
```

Repeat at equal first-phase peak instead of equal asymptotic drive:

```bash
python sweep_thresholds.py --taus 0.01 0.03 0.1 0.3 1 --duration 2 --normalization peak --output results/tau_peak --workers 12
```
